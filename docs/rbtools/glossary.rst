...
.. glossary::
   ...
   pre-commit review
       A form of code review where code is reviewed before it ever gets
       checked into a repository. This is generally a more strict way to
       handle code review, which can lead to fewer problems in the codebase.
