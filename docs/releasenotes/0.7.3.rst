...
* Added a :option:`--disable-cookie-storage` option to prevent cookies from being
  written to disk.
...
* Added support for stamping commits when using :command:`rbt stamp`,
  :command:`rbt post --stamp`, or :command:`rbt land`.
